...
const { mailGunTransporter } = require('./services/mailerTransportLayer');
...
// api for mailgun
app.post('/api/use-mailgun', (req, res) => {
    ...
    const mailOptions = {
        ...
        to: 'recipient@gmail.com', // Replace with the recipient email address
        subject: subject,
        html: html
    };

    // Send the email
    mailGunTransporter.messages.create(process.env.MAILGUN_DOMAIN, mailOptions)
        .then(body => {
